...
<body>
  ...
  <div id="start-screen" style="display: none;">
    ...
    <div class="header">
      ...
      <div class="mode-buttons">
        ...
        <div>
          <button id="btn-shape">Shape Shift</button>
        </div>
      </div>
    </div>
    ...
    <!-- GridTiming-Modal -->
    <div id="gridtiming-modal" class="modal-overlay" style="display:none;">
      <div class="modal-content">
        <button class="modal-close">&times;</button>
  ...
  <!-- Modal: Simon Sagt -->
  <div id="memory-modal" class="modal-overlay" style="display:none;" role="dialog" aria-modal="true" aria-labelledby="memory-title" aria-hidden="true">
    <div class="modal-content">
      <button class="modal-close" aria-label="Schließen">&times;</button>
